...
const work = [
  {
    title: "Cinco Ranch Vanishing Edge",
    location: "Katy, TX",
    year: "2025",
    span: "row-span-2",
    image: "/pool1.png",
